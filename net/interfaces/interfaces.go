...
// whether they're loopback addresses. If there are no regular
// IPv4 and/or IPv6 addresses, it will return any linklocal addresses.
// Some platforms, like AWS Lambda, only have a 169.254.x.x address.
